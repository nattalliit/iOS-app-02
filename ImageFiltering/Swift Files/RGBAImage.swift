...
public struct RGBAImage {
    ...
    public init?(image: UIImage) {
        ...
        //CGContextDrawImage(imageContext, CGRect(origin: CGPoint.zero, size: image.size), cgImage)
    ...
    public func toUIImage() -> UIImage? {
        ...
        guard let imageContext = CGContext(data: imageDataReference, width: width, height: height, bitsPerComponent: 8, bytesPerRow: bytesPerRow, space: colorSpace, bitmapInfo: bitmapInfo, releaseCallback: nil, releaseInfo: nil) else { return nil }
